...
INSERT INTO posts(id, author_id, text_f, attachments_present) VALUES('f1111111-1111-1111-1111-111111111121', '99f2a4dc-3657-4891-839f-29b1397452a5', 'my first post', 'true');
...
VALUES 
('f1111111-1111-1111-1111-111111111111','99f2a4dc-3657-4891-839f-29b1397452a5','Omnissiah','image/png','object_storage','social-net-files','seed-files/Omnissiah.jpg'),
...
INSERT INTO files(id, owner_id, name, mime_type, storage_bucket, storage_key) 
VALUES('f1111111-1111-1111-1111-111111111115','99f2a4dc-3657-4891-839f-29b1397452a5', 'немцы.mp4', 'video/mp4', 'social-net-files', 'seed-files/немцы.mp4'),
('f1111111-1111-1111-1111-111111111116','99f2a4dc-3657-4891-839f-29b1397452a5', 'aud_eng.wav', 'audio/wav', 'social-net-files', 'seed-files/aud_eng.wav');
INSERT INTO post_files (post_id, file_id, ord)
VALUES('f1111111-1111-1111-1111-111111111121','f1111111-1111-1111-1111-111111111114',0);
INSERT INTO post_files (post_id, file_id, ord)
VALUES('f1111111-1111-1111-1111-111111111121','f1111111-1111-1111-1111-111111111115',0);
INSERT INTO post_files (post_id, file_id, ord)
VALUES('f1111111-1111-1111-1111-111111111121','f1111111-1111-1111-1111-111111111116',0);
